...
public class ContainsAllValidator implements IValidator {
    ...
    /**
     * Constructor that kicks off the loop and stores necessary values for
     * isValid().
     *
     * @param fromTree the integers from this tree must be in the second tree
     *                 provided
    ...
    /**
     * Produces a boolean representing if all elements fromTree are located within
     * inTree
     *
