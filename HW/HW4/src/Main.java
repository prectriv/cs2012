...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // IBinTreeStrategy mhs = new MaxHeapStrategy();
        IBinTreeStrategy mhs = new MaxHeapStrategy2();
        ...
        // Make a balanced binary tree with the following integers (not guaranteed to be
        // a heap)
