...
public class ElectionData {
    ...
    /**
     * Accepts 3 strings, representing the name of the candidate you wish to vote
     * for.
     * 
     * @param first  your first vote
     * @param second your second vote
     * @param third  your third vote
     * @throws CandidateNotNominatedException when one of the candidates is not
     *                                        nominated
     * @throws MoreThanOnceException          when you vote for a candidate more
     *                                        than once
     */
    ...
    /**
     * Calculates the winner with the strategy passed in via the constructor or
     * altered via .setStrategy()
     * 
     * @return an optional containing the winner if there is a valid one present, or
     *         an empty if there is no valid winner.
     */
